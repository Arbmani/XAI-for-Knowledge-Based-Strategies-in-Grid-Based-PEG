...
class DQN(nn.Module):
    ...
    def forward(self, evader_probabilities, teammate_probabilities, agent_position, time_left):
        ...
        cnn_output      = self.cnn(torch.cat([evader_map, teammate_map, agent_map], dim=1)).view(batch_size, -1)
